...
def compute_win_rate(exchange_manager):
    ...
    if lost_trades_count > constants.ZERO:
        return won_trades_count / lost_trades_count
    return constants.ZERO if won_trades_count is constants.ZERO else constants.ONE
