...
cdef class Position(util.Initializable):
    ...
    cpdef object get_bankruptcy_price(self, bint with_mark_price=*, object price=*, object side=*)
    ...
    cpdef object get_fee_to_close(self, object quantity=*, object price=*, bint with_mark_price=*, object side=*)
