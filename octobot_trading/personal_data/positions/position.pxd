...
cdef class Position(util.Initializable):
    ...
    cdef void _update_realized_pnl_from_size_update(self, object size_update, bint is_closing=*, object order_price=*)
    ...
    cdef object _update_size(self, object update_size, object order_price=*)  # needs object to forward exceptions
