...
class Position(util.Initializable):
    ...
    def update_from_raw(self, raw_position):
        ...
        return self._update(
            ...
            liquidation_price=raw_position.get(enums.ExchangeConstantsPositionColumns.LIQUIDATION_PRICE.value,
                                               constants.ZERO),
            quantity=raw_position.get(enums.ExchangeConstantsPositionColumns.CONTRACT_SIZE.value, constants.ZERO),
            size=raw_position.get(enums.ExchangeConstantsPositionColumns.POSITION_SIZE.value, constants.ZERO),
            value=raw_position.get(enums.ExchangeConstantsPositionColumns.POSITION_VALUE.value, constants.ZERO),
    ...
    def to_dict(self):
        return {
            ...
            enums.ExchangeConstantsPositionColumnsPOSITION_SIZE.value: self.size,
