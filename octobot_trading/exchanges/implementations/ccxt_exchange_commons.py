...
class CCXTExchangeCommons(abstract_exchange.AbstractExchange):
    ...
    async def create_order(
        ...
        async with self._order_operation(
            ...
            return await self.connector.parse_order(
                raw_created_order,
    ...
    async def _edit_order(
        ...
        return await self.connector.client.edit_order(
    ...
    async def _create_specific_order(
        ...
        if order_type == enums.TraderOrderType.BUY_MARKET:
            raw_created_order = await self._create_market_buy_order(
                symbol, float_quantity, price=float_price, params=params
            )
        elif order_type == enums.TraderOrderType.BUY_LIMIT:
            raw_created_order = await self._create_limit_buy_order(
                symbol, float_quantity, price=float_price, params=params
            )
        elif order_type == enums.TraderOrderType.SELL_MARKET:
            raw_created_order = await self._create_market_sell_order(
                symbol, float_quantity, price=float_price, params=params
            )
        elif order_type == enums.TraderOrderType.SELL_LIMIT:
            raw_created_order = await self._create_limit_sell_order(
                symbol, float_quantity, price=float_price, params=params
            )
        elif order_type == enums.TraderOrderType.STOP_LOSS:
            raw_created_order = await self._create_market_stop_loss_order(
                symbol,
                float_quantity,
                price=float_price,
                side=side,
            ...
            raw_created_order = await self._create_limit_stop_loss_order(
                symbol, float_quantity, price=float_price, side=side, params=params
            )
        elif order_type == enums.TraderOrderType.TAKE_PROFIT:
            raw_created_order = await self._create_market_take_profit_order(
                symbol, float_quantity, price=float_price, side=side, params=params
            )
        elif order_type == enums.TraderOrderType.TAKE_PROFIT_LIMIT:
            raw_created_order = await self._create_limit_take_profit_order(
                symbol, float_quantity, price=float_price, side=side, params=params
            )
        elif order_type == enums.TraderOrderType.TRAILING_STOP:
            raw_created_order = await self._create_market_trailing_stop_order(
                symbol, float_quantity, price=float_price, side=side, params=params
            )
        elif order_type == enums.TraderOrderType.TRAILING_STOP_LIMIT:
            raw_created_order = await self._create_limit_trailing_stop_order(
                symbol, float_quantity, price=float_price, side=side, params=params
            )
    ...
    async def _create_limit_buy_order(
        ...
        return await self.connector.client.create_limit_buy_order(
    ...
    async def _create_limit_sell_order(
        ...
        return await self.connector.client.create_limit_sell_order(
            symbol, quantity, price, params=params
        )
    ...
    async def get_symbol_prices(
        ...
        **kwargs: dict,
        ...
        return await self.connector.get_symbol_prices(
            symbol=symbol, time_frame=time_frame, limit=limit, **kwargs
        )

    async def get_kline_price(
        self, symbol: str, time_frame: common_enums.TimeFrames, **kwargs: dict
    ) -> typing.Optional[list]:
        return await self.connector.get_kline_price(
    ...
    async def get_order(
        ...
        order_id: str,
        symbol: str = None,
        check_completeness: bool = None,
        **kwargs: dict,
    ) -> dict:
        return await self.connector.get_order(
            symbol=symbol,
            order_id=order_id,
    ...
    async def get_all_orders(
        ...
        **kwargs: dict,
        ...
        return await self.connector.get_all_orders(
            symbol=symbol,
            since=since,
            limit=limit,
            check_completeness=check_completeness,
    ...
    async def get_closed_orders(
        ...
        **kwargs: dict,
        ...
        return await self.connector.get_closed_orders(
            symbol=symbol,
            since=since,
            limit=limit,
            check_completeness=check_completeness,
    ...
    async def get_my_recent_trades(
        ...
        **kwargs: dict,
        ...
        return await self.connector.get_my_recent_trades(
            symbol=symbol,
            since=since,
            limit=limit,
            check_completeness=check_completeness,
    ...
    async def get_recent_trades(
        ...
        **kwargs: dict,
        ...
        return await self.connector.get_recent_trades(
    ...
    async def cancel_order(
        ...
        return await self.connector.cancel_order(
            symbol=symbol, order_id=order_id, **kwargs
        )

    def get_trade_fee(self, symbol, order_type, quantity, price, taker_or_maker):
        return self.connector.get_trade_fee(
    ...
    def parse_balance(self, balance):
        return personal_data.parse_decimal_portfolio(
            self.connector.parse_balance(balance)
        )
    ...
    def parse_timestamp(self, data_dict, timestamp_key, default_value=None, ms=False):
        return self.connector.parse_timestamp(
            data_dict, timestamp_key, default_value=default_value, ms=ms
        )
