...
def _get_cryptocurrencies_to_create(trading_mode_class: modes.AbstractTradingMode.__class__,
...
def _get_symbols_to_create(trading_mode_class: modes.AbstractTradingMode.__class__,
                           symbols: list) -> list:
    return symbols if symbols and not trading_mode_class.get_is_symbol_wildcard() else [None]


def _get_time_frames_to_create(trading_mode_class: modes.AbstractTradingMode.__class__,
