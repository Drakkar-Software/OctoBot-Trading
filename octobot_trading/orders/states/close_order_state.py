...
class CloseOrderState(OrderState):
    def __init__(self, order, from_exchange_data, force_close=False):
        super().__init__(order, from_exchange_data)
        self.state = OrderStates.CLOSED if from_exchange_data or force_close else OrderStates.CLOSING
