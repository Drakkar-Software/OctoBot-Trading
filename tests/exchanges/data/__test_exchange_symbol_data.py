...
class TestExchangeSymbolData:
    def test_update_symbol_candles(self):
        ...
        test_inst = ExchangeSymbolData(symbol)
    ...
    def test_max_symbol_candles(self):
        ...
        fake_candles = [self.create_fake_candle(i) for i in range(ExchangeSymbolData.MAX_CANDLES_COUNT)]
        test_inst.update_symbol_candles(tf, fake_candles, replace_all=True)
        assert len(test_inst.get_candle_data(tf).get_symbol_volume_candles()) == ExchangeSymbolData.MAX_CANDLES_COUNT
        ...
        assert len(candle_data.get_symbol_volume_candles()) == ExchangeSymbolData.MAX_CANDLES_COUNT
