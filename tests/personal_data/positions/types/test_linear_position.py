...
async def test_update_value(future_trader_simulator):
    ...
    position_inst.update(update_quantity=constants.ZERO)
    position_inst.update_value()
    assert position_inst.value == constants.ZERO
    position_inst.update(update_quantity=constants.ONE_HUNDRED)
    position_inst.update_value()
    assert position_inst.value == constants.ZERO
...
async def test_update_pnl(future_trader_simulator):
    ...
    position_inst.update(update_quantity=constants.ONE_HUNDRED, mark_price=constants.ONE_HUNDRED)
...
async def test_update_initial_margin(future_trader_simulator):
    ...
    position_inst.update(update_quantity=constants.ZERO, mark_price=constants.ZERO)
