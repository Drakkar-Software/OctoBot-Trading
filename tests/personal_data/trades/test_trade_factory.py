...
class TestTradeFactory:
    ...
    async def test_create_trade_instance_from_raw(self):
        ...
        raw_trade = {	
            ExchangeConstantsOrderColumns.ID: "12345-67890:09876/54321",
            ExchangeConstantsOrderColumns.STATUS: OrderStatus.CLOSED.value,
            ExchangeConstantsOrderColumns.TIMESTAMP: 1502962946,
            ExchangeConstantsOrderColumns.SYMBOL: "ETH/BTC",
            ExchangeConstantsOrderColumns.ORDER: "12345-67890:09876/54321",
            ...
            ExchangeConstantsOrderColumns.TAKER_OR_MAKER: ExchangeConstantsMarketPropertyColumns.MAKER.value,
            ExchangeConstantsOrderColumns.PRICE: decimal.Decimal("0.06917684"),
