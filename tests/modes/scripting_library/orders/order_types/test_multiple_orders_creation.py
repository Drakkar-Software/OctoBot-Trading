...
async def test_amount_then_position_sequence(mock_context):
    ...
    with mock.patch.object(trading_personal_data, "get_up_to_date_price", mock.AsyncMock(return_value=btc_price)), \
        ...
        _ensure_orders_validity(mock_context, btc_val, usdt_val)
...
def _ensure_orders_validity(mock_context, btc_available, usdt_available, btc_total=None, usdt_total=None):
