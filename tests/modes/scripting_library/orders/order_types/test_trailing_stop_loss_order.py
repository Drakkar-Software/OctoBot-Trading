...
import octobot_trading.modes.scripting_library.orders.order_types.trailing_stop_loss_order as trailing_stop_loss_order
...
async def test_trailing_stop_loss(null_context):
    with mock.patch.object(create_order, "create_order_instance", mock.AsyncMock()) as create_order_instance:
        await trailing_stop_loss_order.trailing_stop_loss(null_context, "side", "symbol", "amount", "target_position",
                                                          "offset", "one_cancels_the_other", "tag", "linked_to")
        create_order_instance.assert_called_once_with(
            ...
            order_type_name="trailing_stop_loss", order_offset="offset", reduce_only=True,
            one_cancels_the_other="one_cancels_the_other", tag="tag", linked_to="linked_to")
