...
packages_list = ["octobot_trading.util.initializable",
                 ...
                 "octobot_trading.data_adapters.order_adapter",
                 "octobot_trading.data_factories.order_factory",
                 "octobot_trading.data_factories.order_state_factory",
                 "octobot_trading.data_factories.portfolio_factory",
                 "octobot_trading.data_factories.trade_factory",
