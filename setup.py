...
packages_list = ["octobot_trading.util.initializable",
                 ...
                 "octobot_trading.exchange_data.candles_adapter",
                 "octobot_trading.exchange_data.candles_manager",
                 "octobot_trading.exchange_data.funding_manager",
                 "octobot_trading.exchange_data.kline_manager",
                 "octobot_trading.exchange_data.price_events_manager",
                 "octobot_trading.exchange_data.prices_manager",
                 "octobot_trading.exchange_data.order_book_manager",
                 "octobot_trading.exchange_data.ticker_manager",
                 "octobot_trading.exchange_data.recent_trades_manager",
                 "octobot_trading.orders.order",
                 "octobot_trading.orders.order_adapter",
                 "octobot_trading.orders.order_factory",
                 "octobot_trading.orders.orders_manager",
                 ...
                 "octobot_trading.futures.future_contract",
                 "octobot_trading.futures.position",
                 "octobot_trading.futures.positions_manager",
                 "octobot_trading.traders.trader",
                 "octobot_trading.traders.trader_simulator",
                 "octobot_trading.trades.trade",
                 "octobot_trading.trades.trade_factory",
                 "octobot_trading.trades.trades_manager",
                 ...
                 "octobot_trading.channels.futures",
