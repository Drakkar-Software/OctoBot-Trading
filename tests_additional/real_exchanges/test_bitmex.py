...
class TestBitmexRealExchangeTester(RealExchangeTester):
    ...
    async def test_active_symbols(self):
        await self.inner_test_active_symbols(157, 157)
    ...
    async def test_get_market_status(self):
        for market_status in await self.get_market_statuses():
            ...
            assert 0 < market_status[Ecmsc.PRECISION.value][
                Ecmsc.PRECISION_PRICE.value] <= 1  # to be fixed in bitmex tentacle
