...
class TestPolymarketRealExchangeTester(RealOptionExchangeTester):
    ...
    SYMBOL = f"will-bitcoin-replace-sha-256-before-2027/USDC:USDC-261231-0-{common_enums.OptionTypes.CALL.value}"
    SYMBOL_2 = f"will-the-us-confirm-that-aliens-exist-before-2027/USDC:USDC-261231-0-{common_enums.OptionTypes.CALL.value}"
    SYMBOL_3 = f"10pt0-or-above-earthquake-before-2027/USDC:USDC-261231-0-{common_enums.OptionTypes.CALL.value}"
